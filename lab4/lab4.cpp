...
int main(int argc, char **argv) {
    ...
    // lab4 below
    // bootup wallpaper
    cv::Mat bootup_img = cv::imread("/run/media/mmcblk1p1/video/pepe.png", cv::IMREAD_COLOR);
    
    // https://shimat.github.io/opencvsharp_docs/html/02d3e356-cf12-7ddc-d451-4872a206a5ec.htm
    cv::resize(bootup_img, bootup_img, video_size, cv::INTER_LINEAR);

    for (int i = 0; i < 30 ; ++i)
        print_frame(bootup_img, ofs, fb_info);
